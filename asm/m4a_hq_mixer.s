 ...
 * licensed under GPLv3, see LICENSE.txt for details */
    ...
    .include "m4a_hq_mixer_config.inc"
    ...
    .global M4aHqMixerIwramStart
    .global M4aHqMixerIwramEnd

M4aHqMixerIwramStart:
SoundMainRAM:
    ...
    ADR     R0, C_clear_hq_mix_buffer_impl
    BX      R0
...
C_mixing_setup_comp_rev:
    ...
    BNE     C_setup_synth
    /*
     * DPCM decode/interpolation expects 0-127 effective volume; halve there only.
     * Uncompressed BGM PCM (key-split hits on Clock Tower / Your Home) must keep
     * full 0-255 scaling like vanilla or the DS layer sits under the CGB bed.
     */
    TST     R0, #MODE_COMP
    BEQ     C_mixing_setup_skip_vol_halve
    MOVS    R11, R11, LSR#1
    ADC     R11, R11, #0x8000
    BIC     R11, R11, #0x8000
C_mixing_setup_skip_vol_halve:
...
M4aHqMixerIwramEnd:
    ...
    .section .append_rodata, "a", %progbits
    .align  2
    .global MixerSize
MixerSize:
