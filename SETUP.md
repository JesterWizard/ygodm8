...
`ygodm8` builds with the legacy `agbcc` toolchain. This document covers requirements, installation, building, and troubleshooting.
...
Pick one setup path below, then follow [Installation](#installation).
