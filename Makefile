...
NARROW_FONT_PERCENT_PNG := src_custom/assets/fonts/latin_narrow.png
...
# Fill missing 80x80 PNGs from 512x512 sources (batch skips existing outputs).
CARD_80_FROM_512_STAMP := $(BUILD_DIR)/.card_80_from_512.stamp
$(CARD_80_FROM_512_STAMP): $(BATCH_80X80) $(CUSTOM_CARD_512_PNGS)
	@mkdir -p $(dir $@)
	python3 $(BATCH_80X80)
	touch $@
...
$(CARD_ART_STAMP): $(CARD_ART_GENERATOR) $(CARD_DATA_MANIFEST) $(CARD_80_FROM_512_STAMP) $(CUSTOM_CARD_80_PNGS) $(CUSTOM_CARD_24_PNGS) src_custom/assets/cards/mini.pal
	@mkdir -p $(dir $@)
...
$(NARROW_FONT_GENERATED): $(NARROW_FONT_PNG) $(NARROW_FONT_PERCENT_PNG) $(NARROW_FONT_GENERATOR)
	@echo "FONT    narrow description"
	python3 $(NARROW_FONT_GENERATOR) --png $(NARROW_FONT_PNG) --percent-png $(NARROW_FONT_PERCENT_PNG) --out $@
...
CUSTOM_MAP_GENERATED := src_custom/generated/maps/custom_map_dispatch.inc src_custom/generated/maps/custom_map_connections.inc src_custom/generated/maps/manifest_map_sources.inc src_custom/generated/maps/manifest_collision_overrides.inc src_custom/generated/maps/manifest_connection_overrides.inc src_custom/generated/maps/manifest_spawn_overrides.inc
...
CARD_FRAME_BORDERS := $(wildcard src_custom/assets/cards/frames/*.4bpp)
...
$(eval $(call custom_object_dep,spell_effects/polymerization,$(CARD_EFFECT_TEXTS_H)))
...
$(eval $(call custom_object_dep,menu_cursor,$(CURSOR_4BPP) $(CURSOR_PAL)))
$(eval $(call custom_object_dep,debug/debug_menu_cursor,$(CURSOR_4BPP) $(CURSOR_PAL)))
...
$(eval $(call custom_object_dep,timed_duel,src_custom/debug/debug_menu_timed_duel_table.inc include/debug_menu_timed_duel_layouts.h))
$(eval $(call custom_object_dep,mechanics_tutorial,src_custom/debug/debug_menu_mechanics_table.inc src_custom/debug/debug_menu_mechanics_scripts.inc include/debug_menu_mechanics_layouts.h))
