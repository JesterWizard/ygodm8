...
THOUGHT_BUBBLE_PNGS := $(shell find src/hooks/assets/thought_bubbles -type f -name '*.png' | sort)
...
clean-graphics:
	...
	find src/hooks/assets/thought_bubbles -type f \( -name '*.4bpp' -o -name '*.obj.4bpp' -o -name '*.dmp' -o -name '*.gbapal' -o -name '*.lz' \) -delete
...
src/hooks/assets/cards/24x24/%.lz: src/hooks/assets/cards/24x24/%.4bpp | tools-rules
	tools/gbagfx/gbagfx $< $@
src/hooks/assets/thought_bubbles/%.dmp: src/hooks/assets/thought_bubbles/%.png tools/repack_128x64_obj.py | tools-rules
