...
void SetShopCardQty(unsigned short cardId, unsigned char qty);
unsigned char GetShopTempCardQty(unsigned short cardId);
void SetShopTempCardQty(unsigned short cardId, unsigned char qty);
unsigned char GetPlayerTempCardQty(unsigned short cardId);
void SetPlayerTempCardQty(unsigned short cardId, unsigned char qty);
