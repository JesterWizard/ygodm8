 ...
 * has drawn the new card on screen. Saves the live duel display (OBJ
 * VRAM, OAM, palette, DISPCNT, window + blend regs), plays the popup
 * GFX effect over the dimmed-but-intact duel board, then restores the
 * duel display and resumes.                                      */
