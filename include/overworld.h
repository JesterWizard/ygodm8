...
enum Portrait {
  ...
  PORTRAIT_MAKO_UNUSED = 11,
  PORTRAIT_MAKO = 12,
  PORTRAIT_WEEVIL = 13,
  PORTRAIT_ESPA_ROBA = 14,
  PORTRAIT_BONZ = 15,
  PORTRAIT_ISHIZU = 16,
  PORTRAIT_PANICK_UNUSED = 17,
  PORTRAIT_MIMIC_OF_DOOM = 18,
  PORTRAIT_PANICK = 19,
  PORTRAIT_BANDIT_KEITH = 20,
  PORTRAIT_STRINGS = 21,
  PORTRAIT_ARCANA_UNUSED = 22,
  PORTRAIT_ARCANA = 23,
  PORTRAIT_PARA = 24,
  PORTRAIT_DOX = 25,
  PORTRAIT_LUMIS = 26,
  ...
  PORTRAIT_ROBOT_MONKEY_UNUSED = 35,
  PORTRAIT_NOAH = 36,
  PORTRAIT_DARK_JOEY = 37,
  PORTRAIT_ROBOT_MOkNEY = 38,
  PORTRAIT_REBECCA = 39,
  PORTRAIT_KAIBAMAN_UNUSED = 40,
  PORTRAIT_KAIBAMAN_UNUSED_2 = 41,
  PORTRAIT_MARIK_UNUSED = 42,
  PORTRAIT_MILLENIMUM_GUARDIAN_UNUSED = 43,
  PORTRAIT_JINZO = 44,
