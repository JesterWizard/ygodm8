...
const RuntimeConfig gRuntimeConfig __attribute__((section(".runtime_config"))) = {
    ...
    .fast_ai = TRUE,
    .card_in_hand_1 = ELEMENTAL_HERO_CAPTAIN_GOLD,
    .card_in_hand_2 = SKYSCRAPER,
    .card_in_hand_3 = ELEMENTAL_HERO_AVIAN,
    .card_in_hand_4 = ELEMENTAL_HERO_BURSTINATRIX,
    .card_in_hand_5 = POLYMERIZATION,
    .opponent_deck_card_id = BLUE_EYES_WHITE_DRAGON,
    .player_deck_card_id = SKYSCRAPER,
    .skip_to_duel = TRUE,
