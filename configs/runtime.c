...
const RuntimeConfig gRuntimeConfig __attribute__((section(".runtime_config"))) = {
    ...
    .card_in_hand_1 = CHAOS_COMMAND_MAGICIAN,
    .card_in_hand_2 = HARPIE_LADY_1,
    .card_in_hand_3 = HARPIE_LADY_2,
    .card_in_hand_4 = HARPIE_LADY_3,
    .card_in_hand_5 = CARD_NONE,
    .opponent_deck_card_id = CHIRON_THE_MAGE,
    .skip_to_duel = TRUE,
