...
const RuntimeConfig gRuntimeConfigRom __attribute__((section(".runtime_config"))) = {
    ...
    .card_in_hand_1 = LEGENDARY_KNIGHT_CRITIAS,
    .card_in_hand_2 = LEGENDARY_KNIGHT_HERMOS,
    .card_in_hand_3 = LEGENDARY_KNIGHT_TIMAEUS,
    .card_in_hand_4 = LEKUNGA,
    .card_in_hand_5 = LIGHT_AND_DARKNESS_DRAGON,
