...
const RuntimeConfig gRuntimeConfig __attribute__((section(".runtime_config"))) = {
    ...
    .card_in_hand_1 = LEVEL_LIMIT_AREA_A,
    .card_in_hand_2 = FOREST,
    .card_in_hand_3 = UMI,
    .card_in_hand_4 = HOURGLASS_OF_LIFE,
    .card_in_hand_5 = THE_SANCTUARY_IN_THE_SKY,
    .opponent_deck_card_id = CARD_NONE,
    .skip_to_duel = TRUE,
    .skip_to_duel_opponent_id = DUELIST_DARK_MARIK_135,
