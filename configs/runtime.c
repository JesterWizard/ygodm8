...
const RuntimeConfig gRuntimeConfig __attribute__((section(".runtime_config"))) = {
    ...
    .fast_ai = TRUE,
    .card_in_hand_1 = DARK_ARMED_DRAGON,
    .card_in_hand_2 = DARK_END_DRAGON,
    .card_in_hand_3 = MAMMOTH_GRAVEYARD,
    .card_in_hand_4 = THE_WICKED_AVATAR,
    .card_in_hand_5 = MYSTIC_LAMP,
    .opponent_deck_card_id = BLADE_KNIGHT,
