...
const RuntimeConfig gRuntimeConfig __attribute__((section(".runtime_config"))) = {
    ...
    .instant_win_with_start_button = TRUE,
    .enable_surrender_in_duel_b_menu = TRUE,
    .expand_graveyard = TRUE,
    .enable_removed_from_play_zone = TRUE,
    ...
    .fast_ai = TRUE,
    .card_in_hand_1 = YUBEL,
    .card_in_hand_2 = YUBEL_TERROR_INCARNATE,
    .card_in_hand_3 = YUBEL_THE_ULTIMATE_NIGHTMARE,
    .card_in_hand_4 = DOUBLE_SUMMON,
    .card_in_hand_5 = HOURGLASS_OF_LIFE,
    .opponent_deck_card_id = RAIGEKI,
    .player_deck_card_id = VALHALLA_HALL_OF_THE_FALLEN,
    .skip_to_duel = TRUE,
