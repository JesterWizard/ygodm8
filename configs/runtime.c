...
const RuntimeConfig gRuntimeConfigRom __attribute__((section(".runtime_config"))) = {
    ...
    .card_in_hand_1 = MASK_OF_DISPEL,
    .card_in_hand_2 = MASK_OF_THE_ACCURSED,
    .card_in_hand_3 = MASTER_PEACE_THE_TRUE_DRACOSLAYING_KING,
    .card_in_hand_4 = MAUSOLEUM_OF_THE_EMPEROR,
    .card_in_hand_5 = MARSHMALLON,
