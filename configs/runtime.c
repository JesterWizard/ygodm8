...
const RuntimeConfig gRuntimeConfig __attribute__((section(".runtime_config"))) = {
    ...
    .fast_ai = TRUE,
    .card_in_hand_1 = ELEMENTAL_HERO_SUNRISE,
    .card_in_hand_2 = POLYMERIZATION,
    .card_in_hand_3 = ELEMENTAL_HERO_PLASMA_VICE,
    .card_in_hand_4 = ELEMENTAL_HERO_CLAYMAN,
    .card_in_hand_5 = ELEMENTAL_HERO_AVIAN,
    .opponent_deck_card_id = BLUE_EYES_WHITE_DRAGON,
    .player_deck_card_id = MIRACLE_FUSION,
    .skip_to_duel = TRUE,
