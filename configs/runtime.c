...
const RuntimeConfig gRuntimeConfig __attribute__((section(".runtime_config"))) = {
    ...
    .fast_ai = TRUE,
    .card_in_hand_1 = ELEMENTAL_HERO_NEOS_ALIUS,
    .card_in_hand_2 = ELEMENTAL_HERO_BURSTINATRIX,
    .card_in_hand_3 = ELEMENTAL_HERO_CLAYMAN,
    .card_in_hand_4 = ELEMENTAL_HERO_AVIAN,
    .card_in_hand_5 = ELEMENTAL_HERO_BUBBLEMAN,
