...
typedef struct {
    ...
    u8 use_custom_start_map; // When TRUE (and story mode is off), new game uses the custom start map below.
    u8 custom_start_map_id;
    u8 custom_start_map_state;
    u8 custom_start_map_connection;
