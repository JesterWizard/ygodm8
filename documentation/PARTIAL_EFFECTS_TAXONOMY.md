...
|-----|------:|-----------------|
| `other` | 84 | triage |
| `event.OnStandby` | 72 | 3 (OPT / turn flags) |
| `gate.Tribute` | 23 | 2–3 |
| `chain.Negate` | 18 | later / chain |
| `event.OnSummon` | 18 | 3 |
| `event.OnDestroy` | 9 | 3 |
| `op.BanishTimed` | 9 | 1–3 |
| `op.Search` | 8 | 1 |
| `event.GyIgnition` | 7 | 3 |
| `event.OnBattleDestroy` | 7 | 3 |
| `stat.Continuous` | 2 | 1–3 |
| `ui.Choice` | 2 | 2 |
