...
|-----|------:|-----------------|
| `other` | 332 | triage |
| `event.OnStandby` | 246 | 3 (OPT / turn flags) |
| `event.OnBattleDestroy` | 80 | 3 |
| `event.OnSummon` | 69 | 3 |
| `ui.Choice` | 56 | 2 |
| `chain.Negate` | 52 | later / chain |
| `gate.Tribute` | 39 | 2–3 |
| `event.OnDestroy` | 35 | 3 |
| `op.Search` | 33 | 1 |
| `stat.Continuous` | 24 | 1–3 |
