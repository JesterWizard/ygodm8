...
|-----|------:|-----------------|
| `event.OnStandby` | 195 | 3 (OPT / turn flags) |
| `other` | 190 | triage |
| `event.OnSummon` | 58 | 3 |
| `event.OnBattleDestroy` | 43 | 3 |
| `chain.Negate` | 34 | later / chain |
| `gate.Tribute` | 31 | 2–3 |
| `event.OnDestroy` | 19 | 3 |
| `op.Search` | 18 | 1 |
| `op.BanishTimed` | 13 | 1–3 |
| `event.GyIgnition` | 11 | 3 |
| `stat.Continuous` | 10 | 1–3 |
| `ui.Choice` | 10 | 2 |
