...
| `stat.Continuous` | 27 | 1–3 |
| `op.BanishTimed` | 22 | 1–3 |
...
- `CYBERNETIC_ZONE` (spell): L167: stage unit is 500 ATK — double via +original/500 stages. Ceiling: non-multiples of 500 are floored; upgrade: exact ATK overlay.
