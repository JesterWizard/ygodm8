...
|-----|------:|-----------------|
| `other` | 250 | triage |
| `event.OnStandby` | 217 | 3 (OPT / turn flags) |
| `event.OnBattleDestroy` | 64 | 3 |
| `event.OnSummon` | 62 | 3 |
| `ui.Choice` | 55 | 2 |
| `chain.Negate` | 43 | later / chain |
| `gate.Tribute` | 38 | 2–3 |
| `event.OnDestroy` | 24 | 3 |
| `op.Search` | 23 | 1 |
| `op.BanishTimed` | 19 | 1–3 |
