...
| `gate.Tribute` | 43 | 2–3 |
| `op.Search` | 38 | 1 |
| `event.OnDestroy` | 37 | 3 |
| `stat.Continuous` | 28 | 1–3 |
| `op.BanishTimed` | 23 | 1–3 |
...
- `CHARGE_OF_THE_LIGHT_BRIGADE` (spell): L149: legacy single-card GY — milled cards vanish from deck only.
