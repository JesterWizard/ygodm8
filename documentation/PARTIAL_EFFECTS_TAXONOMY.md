...
|-----|------:|-----------------|
| `other` | 252 | triage |
| `event.OnStandby` | 222 | 3 (OPT / turn flags) |
| `event.OnBattleDestroy` | 65 | 3 |
| `event.OnSummon` | 62 | 3 |
| `ui.Choice` | 55 | 2 |
| `chain.Negate` | 43 | later / chain |
| `gate.Tribute` | 38 | 2–3 |
| `event.OnDestroy` | 26 | 3 |
| `op.Search` | 25 | 1 |
