...
|-----|------:|-----------------|
| `other` | 337 | triage |
| `event.OnStandby` | 248 | 3 (OPT / turn flags) |
| `event.OnBattleDestroy` | 81 | 3 |
| `event.OnSummon` | 70 | 3 |
| `ui.Choice` | 56 | 2 |
...
| `op.Search` | 33 | 1 |
| `stat.Continuous` | 25 | 1–3 |
| `op.BanishTimed` | 21 | 1–3 |
| `event.GyIgnition` | 14 | 3 |
| `equip.Register` | 2 | 1 (lists) |
