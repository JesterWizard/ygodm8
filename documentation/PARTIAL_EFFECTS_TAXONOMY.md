...
|-----|------:|-----------------|
| `other` | 149 | triage |
| `event.OnStandby` | 134 | 3 (OPT / turn flags) |
| `event.OnSummon` | 36 | 3 |
| `chain.Negate` | 27 | later / chain |
| `gate.Tribute` | 26 | 2–3 |
| `event.OnBattleDestroy` | 13 | 3 |
| `event.OnDestroy` | 12 | 3 |
| `op.Search` | 12 | 1 |
| `event.GyIgnition` | 11 | 3 |
| `op.BanishTimed` | 11 | 1–3 |
| `ui.Choice` | 6 | 2 |
