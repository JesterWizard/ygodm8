...
| `EVIL_HERO_INFERNO_WING_BACKFIRE` | `EVIL_HERO_INFERNO` | — | `THUNDER_DRAGON_COLOSSUS` | `src_custom/permanent_effects/evil_hero_inferno_wing_backfire.c` |
...
| `HARPIE_PERFUMER` | `HARPIE` | — | `GLADIATOR_BEAST_SAMNITE` | `src_custom/permanent_effects/harpie_perfumer.c` |
