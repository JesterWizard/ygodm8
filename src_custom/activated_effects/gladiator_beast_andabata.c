...
static u8 CanTagOut(void)
{
  ...
  return DeckHasTwoDifferentGladiatorBeasts(GLADIATOR_BEAST_ANDABATA);
}
...
static void ShuffleSelfTagOut(struct DuelCard *self)
{
  ...
  SpecialSummonTwoGladiatorBeastsFromDeck(GLADIATOR_BEAST_ANDABATA);
}
...
void ActivateGLADIATOR_BEAST_ANDABATAEffect(void)
{
  ...
  Duel_ShowEffectTextTyped(GLADIATOR_BEAST_ANDABATA, 2);
