...
unsigned char ShouldActivateHORUS_THE_BLACK_FLAME_DRAGON_LV4(void)
{
  ...
  if (gActiveEffect.cardId != HORUS_THE_BLACK_FLAME_DRAGON_LV4)
    return FALSE;

  if (GetPendingTributeSummonCardId() != HORUS_THE_BLACK_FLAME_DRAGON_LV4)
    return FALSE;
...
void ActivateHORUS_THE_BLACK_FLAME_DRAGON_LV4(void)
{
  ...
  Duel_ShowEffectTextTyped(HORUS_THE_BLACK_FLAME_DRAGON_LV4, 8);
