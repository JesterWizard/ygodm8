...
unsigned char ShouldActivateHORUS_THE_BLACK_FLAME_DRAGON_LV6(void)
{
  ...
  if (gActiveEffect.cardId != HORUS_THE_BLACK_FLAME_DRAGON_LV6)
    return FALSE;

  if (GetPendingTributeSummonCardId() != HORUS_THE_BLACK_FLAME_DRAGON_LV6)
    return FALSE;
...
void ActivateHORUS_THE_BLACK_FLAME_DRAGON_LV6(void)
{
  ...
  Duel_ShowEffectTextTyped(HORUS_THE_BLACK_FLAME_DRAGON_LV6, 8);
