...
unsigned char ShouldActivateGLADIATOR_BEAST_ALEXANDER(void)
{
  ...
  if (gActiveEffect.cardId != GLADIATOR_BEAST_ALEXANDER)
    return FALSE;

  if (GetPendingTributeSummonCardId() != GLADIATOR_BEAST_ALEXANDER)
    return FALSE;
...
void ActivateGLADIATOR_BEAST_ALEXANDER(void)
{
  ...
  Duel_ShowEffectTextTyped(GLADIATOR_BEAST_ALEXANDER, 8);
