...
unsigned char CanActivateMonsterEffect(void) {
  ...
  if (gMonEffect.id == ELEMENTAL_HERO_NEOS_ALIUS)
  ...
  else if (gMonEffect.id == AMAZONESS_SPIRITUALIST)
    canActivate = CanActivateAMAZONESS_SPIRITUALIST();
  else if (gMonEffect.id == MORPHTRONIC_EARFON)
    canActivate = CanActivateMORPHTRONIC_EARFON();
  else if (gMonEffect.id == ELEMENTAL_HERO_SPIRIT_OF_NEOS)
    canActivate = CanActivateELEMENTAL_HERO_SPIRIT_OF_NEOS();
  else if (gMonEffect.id == GLADIATOR_BEAST_DOMITIANUS)
    canActivate = CanActivateGLADIATOR_BEAST_DOMITIANUS();
  else if (gMonEffect.id == ANCIENT_GEAR_GOLEM_ULTIMATE_POUND)
    canActivate = CanActivateANCIENT_GEAR_GOLEM_ULTIMATE_POUND();
  else if (gMonEffect.id == ELEMENTAL_HERO_NEBULA_NEOS)
    canActivate = CanActivateELEMENTAL_HERO_NEBULA_NEOS();
  else if (gMonEffect.id == MA_AT)
    canActivate = CanActivateMA_AT();
  else if (gMonEffect.id == PROTECTOR_OF_THE_AGENTS_MOON)
    canActivate = CanActivatePROTECTOR_OF_THE_AGENTS_MOON();
  else if (gMonEffect.id == CYBER_SLASH_HARPY_LADY)
    canActivate = CanActivateCYBER_SLASH_HARPY_LADY();
  else if (gMonEffect.id == CYBER_SLASH_HARPIE_LADY)
    canActivate = CanActivateCYBER_SLASH_HARPIE_LADY();
  else if (gMonEffect.id == EVIL_HERO_DEAD_END_PRISON)
    canActivate = CanActivateEVIL_HERO_DEAD_END_PRISON();
  else if (gMonEffect.id == BLUE_EYES_SPIRIT_DRAGON)
    canActivate = CanActivateBLUE_EYES_SPIRIT_DRAGON();
  else if (gMonEffect.id == BLACK_WINGED_DRAGON)
    canActivate = CanActivateBLACK_WINGED_DRAGON();
  else if (gMonEffect.id == LIGHTRAY_GEARFRIED)
  ...
  else if (gMonEffect.id == GLADIATOR_BEAST_SECUTOR)
    canActivate = CanActivateGLADIATOR_BEAST_SECUTOR();
    ...
    canActivate = CanActivateSILENT_SWORDSMAN_ZERO();
  else if (gMonEffect.id == GLADIATOR_BEAST_DAREIOS)
    canActivate = CanActivateGLADIATOR_BEAST_DAREIOS();
  else if (gMonEffect.id == ELEMENTAL_HERO_GLOW_NEOS)
    canActivate = CanActivateELEMENTAL_HERO_GLOW_NEOS();
  else if (gMonEffect.id == MINERVA_THE_EXHALTED_LIGHTSWORN)
    canActivate = CanActivateMINERVA_THE_EXHALTED_LIGHTSWORN();
  else if (gMonEffect.id == HARPIE_HARPIST)
    canActivate = CanActivateHARPIE_HARPIST();
  else if (gMonEffect.id == HARPIE_CHANNELER)
    canActivate = CanActivateHARPIE_CHANNELER();
  else if (gMonEffect.id == HARPIE_CONDUCTOR)
    canActivate = CanActivateHARPIE_CONDUCTOR();
  else if (gMonEffect.id == HARPIE_DANCER)
    canActivate = CanActivateHARPIE_DANCER();
  else if (gMonEffect.id == HARPIE_ORACLE)
    canActivate = CanActivateHARPIE_ORACLE();
  else if (gMonEffect.id == HARPIE_QUEEN)
    canActivate = CanActivateHARPIE_QUEEN();
  else if (gMonEffect.id == TUALATIN)
    canActivate = CanActivateTUALATIN();
  else if (gMonEffect.id == NEO_BLUE_EYES_ULTIMATE_DRAGON)
    canActivate = CanActivateNEO_BLUE_EYES_ULTIMATE_DRAGON();
  else if (gMonEffect.id == EBON_ILLUSION_MAGICIAN)
    canActivate = CanActivateEBON_ILLUSION_MAGICIAN();
  else if (gMonEffect.id == REPTILIANNE_ECHIDNA)
    canActivate = CanActivateREPTILIANNE_ECHIDNA();
  else if (gMonEffect.id == GLADIATOR_BEAST_TAMER_EDITOR)
    canActivate = CanActivateGLADIATOR_BEAST_TAMER_EDITOR();
  else if (gMonEffect.id == DARK_MAGICIAN_GIRL_THE_MAGICIAN_S_APPRENTICE)
    canActivate = CanActivateDARK_MAGICIAN_GIRL_THE_MAGICIAN_S_APPRENTICE();
  else if (gMonEffect.id == BLUE_EYES_ULTIMATE_SPIRIT_DRAGON)
    canActivate = CanActivateBLUE_EYES_ULTIMATE_SPIRIT_DRAGON();
  else if (gMonEffect.id == GRAVEKEEPERS_SUPERNATURALIST)
    canActivate = CanActivateGRAVEKEEPERS_SUPERNATURALIST();
  else if (gMonEffect.id == ANCIENT_GEAR_DARK_GOLEM)
    canActivate = CanActivateANCIENT_GEAR_DARK_GOLEM();
  else if (gMonEffect.id == MASTER_PEACE_THE_TRUE_DRACOSLAYING_KING)
    canActivate = CanActivateMASTER_PEACE_THE_TRUE_DRACOSLAYING_KING();
  else if (gMonEffect.id == NITRO_WARRIOR)
    canActivate = CanActivateNITRO_WARRIOR();
  else if (gMonEffect.id == ANCIENT_GEAR_TANKER)
  ...
  else if (gMonEffect.id == CYBER_DRAGON_INFINITY)
    canActivate = CanActivateCYBER_DRAGON_INFINITY();
  else if (gMonEffect.id == GRAVEKEEPERS_ORACLE)
    canActivate = CanActivateGRAVEKEEPERS_ORACLE();
  else if (gMonEffect.id == DESTINY_HERO_DARK_ANGEL)
    canActivate = CanActivateDESTINY_HERO_DARK_ANGEL();
  else if (gMonEffect.id == ANCIENT_GEAR_GADJILTRON_DRAGON)
    canActivate = CanActivateANCIENT_GEAR_GADJILTRON_DRAGON();
  else if (gMonEffect.id == DARK_MAGICIAN_GIRL_THE_MAGICIANS_APPRENTICE)
    canActivate = CanActivateDARK_MAGICIAN_GIRL_THE_MAGICIANS_APPRENTICE();
  else if (gMonEffect.id == GORZ_THE_EMISSARY_OF_DARKNESS)
    canActivate = CanActivateGORZ_THE_EMISSARY_OF_DARKNESS();
  else if (gMonEffect.id == MAJESTY_HYPERION)
    canActivate = CanActivateMAJESTY_HYPERION();
  else if (gMonEffect.id == THE_LEGENDARY_EXODIA_INCARNATE)
    canActivate = CanActivateTHE_LEGENDARY_EXODIA_INCARNATE();
  else if (gMonEffect.id == THE_AGENT_OF_LIFE_NEPTUNE)
    canActivate = CanActivateTHE_AGENT_OF_LIFE_NEPTUNE();
  else if (gMonEffect.id == CRIMSON_DRAGON)
    canActivate = CanActivateCRIMSON_DRAGON();
  else if (gMonEffect.id == DESTINY_END_DRAGOON)
  ...
  else if (gMonEffect.id == CELESTIAL_KNIGHTLORD_PARSHATH)
    canActivate = CanActivateCELESTIAL_KNIGHTLORD_PARSHATH();
  else if (gMonEffect.id == ULTIMATE_CONDUCTOR_TYRANNO)
    canActivate = CanActivateULTIMATE_CONDUCTOR_TYRANNO();
  else if (gMonEffect.id == SILENT_SWORDSMAN)
    canActivate = CanActivateSILENT_SWORDSMAN();
  else if (gMonEffect.id == DIVINE_SERPENT_GEH)
    canActivate = CanActivateDIVINE_SERPENT_GEH();
  else if (gMonEffect.id == GUARDIAN_DREADSCYTHE)
    canActivate = CanActivateGUARDIAN_DREADSCYTHE();
  ...
  switch (HandlePlayerMonsterAction()) {
    ...
    case 4: {
      ...
      if (!isFaceUp || zone->id == CANNON_SOLDIER || zone->id == MAN_THRO_TRO
          ...
          || zone->id == AMAZONESS_SPIRITUALIST
          || zone->id == MORPHTRONIC_EARFON
          || zone->id == ELEMENTAL_HERO_SPIRIT_OF_NEOS
          || zone->id == GLADIATOR_BEAST_DOMITIANUS
          || zone->id == ANCIENT_GEAR_GOLEM_ULTIMATE_POUND
          || zone->id == ELEMENTAL_HERO_NEBULA_NEOS
          || zone->id == MA_AT
          || zone->id == PROTECTOR_OF_THE_AGENTS_MOON
          || zone->id == CYBER_SLASH_HARPY_LADY
          || zone->id == EVIL_HERO_DEAD_END_PRISON
          || zone->id == BLUE_EYES_SPIRIT_DRAGON
          || zone->id == BLACK_WINGED_DRAGON
          || zone->id == LIGHTRAY_GEARFRIED
          || zone->id == GLADIATOR_BEAST_NOXIOUS
          || zone->id == POWER_TOOL_BRAVER_DRAGON
          || zone->id == SILENT_SWORDSMAN_ZERO
          || zone->id == GLADIATOR_BEAST_DAREIOS
          || zone->id == ELEMENTAL_HERO_GLOW_NEOS
          || zone->id == MINERVA_THE_EXHALTED_LIGHTSWORN
          || zone->id == HARPIE_HARPIST
          || zone->id == HARPIE_CHANNELER
          || zone->id == HARPIE_CONDUCTOR
          || zone->id == HARPIE_DANCER
          || zone->id == HARPIE_ORACLE
          || zone->id == HARPIE_QUEEN
          || zone->id == CYBER_SLASH_HARPIE_LADY
          || zone->id == CYBER_SLASH_HARPY_LADY
          || zone->id == TUALATIN
          || zone->id == NEO_BLUE_EYES_ULTIMATE_DRAGON
          || zone->id == EBON_ILLUSION_MAGICIAN
          || zone->id == REPTILIANNE_ECHIDNA
          || zone->id == GLADIATOR_BEAST_TAMER_EDITOR
          || zone->id == DARK_MAGICIAN_GIRL_THE_MAGICIAN_S_APPRENTICE
          || zone->id == BLUE_EYES_ULTIMATE_SPIRIT_DRAGON
          || zone->id == GRAVEKEEPERS_SUPERNATURALIST
          || zone->id == ANCIENT_GEAR_DARK_GOLEM
          || zone->id == MASTER_PEACE_THE_TRUE_DRACOSLAYING_KING
          || zone->id == NITRO_WARRIOR
          || zone->id == ANCIENT_GEAR_TANKER
          || zone->id == ENLIGHTENMENT_DRAGON
          || zone->id == CYBER_DRAGON_INFINITY
          || zone->id == GRAVEKEEPERS_ORACLE
          || zone->id == DESTINY_HERO_DARK_ANGEL
          || zone->id == ANCIENT_GEAR_GADJILTRON_DRAGON
          || zone->id == DARK_MAGICIAN_GIRL_THE_MAGICIANS_APPRENTICE
          || zone->id == GORZ_THE_EMISSARY_OF_DARKNESS
          || zone->id == MAJESTY_HYPERION
          || zone->id == THE_LEGENDARY_EXODIA_INCARNATE
          || zone->id == THE_AGENT_OF_LIFE_NEPTUNE
          ...
          || zone->id == CELESTIAL_KNIGHTLORD_PARSHATH
          || zone->id == ULTIMATE_CONDUCTOR_TYRANNO
          || zone->id == SILENT_SWORDSMAN
          || zone->id == DIVINE_SERPENT_GEH
          || zone->id == GUARDIAN_DREADSCYTHE
...
FAILED:
  ...
  if (gMonEffect.id == GLADIATOR_BEAST_SECUTOR) {
    ActivateGLADIATOR_BEAST_SECUTOREffect();
    return;
  }
