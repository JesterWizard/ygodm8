...
| `spell_effects` | `Confiscation` | `src_custom/spell_effects/confiscation.c` |
| `spell_effects` | `Meteor of Destruction` | `src_custom/spell_effects/meteor_of_destruction.c` |
...
| `spell_effects` | `Kaiser Colosseum` | `src_custom/spell_effects/kaiser_colosseum.c` |
...
| `permanent_effects` | `Amazoness Tiger` | `src_custom/permanent_effects/amazoness_tiger.c` |
...
| `trap_effects` | `Mirror Wall` | `src_custom/trap_effects/mirror_wall.c` |
| `trap_effects` | `Dust Tornado` | `src_custom/trap_effects/dust_tornado.c` |
| `turn_effects` | `Mirror Wall` | `src_custom/trap_effects/mirror_wall.c` |
...
| `trap_effects` | `Solar Ray` | `src_custom/trap_effects/solar_ray.c` |
| `trap_effects` | `Solemn Wishes` | `src_custom/trap_effects/solemn_wishes.c` |
...
| `field_spell_effects` | `Divine Sanctuary` | `src_custom/field_spell_effects/divine_sanctuary.c` |
| `trap_effects` | `Angel's Tear` | `src_custom/trap_effects/angels_tear.c` |
...
| `card_passives` | `Mataza the Zapper` | `src_custom/card_passives/mataza_the_zapper.c` |
...
| `permanent_effects` | `Maju Garzett` | `src_custom/permanent_effects/maju_garzett.c` |
...
| `permanent_effects` | `Berserk Gorilla` | `src_custom/permanent_effects/berserk_gorilla.c` |
| `permanent_effects` | `Mobius the Frost Monarch` | `src_custom/permanent_effects/mobius_the_frost_monarch.c` |
| `permanent_effects` | `Theban Nightmare` | `src_custom/permanent_effects/theban_nightmare.c` |
| `permanent_effects` | `Elemental HERO Shining Flare Wingman` | `src_custom/permanent_effects/elemental_hero_shining_flare_wingman.c` |
| `permanent_effects` | `Elemental HERO Shining Phoenix Enforcer` | `src_custom/permanent_effects/elemental_hero_shining_phoenix_enforcer.c` |
...
| `permanent_effects` | `Fire Princess` | `src_custom/permanent_effects/fire_princess.c` |
...
| `battle_effects` | `Elemental HERO Flame Wingman` | `src_custom/battle_effects/elemental_hero_flame_wingman.c` |
...
| `activated_effects` | `Chaos Emperor Dragon Envoy Of The End` | `src_custom/activated_effects/chaos_emperor_dragon_envoy_of_the_end.c` |
...
| `activated_effects` | `Elemental Hero Necroid Shaman` | `src_custom/activated_effects/elemental_hero_necroid_shaman.c` |
| `battle_effects` | `Elemental Hero Plasma Vice` | `src_custom/battle_effects/elemental_hero_plasma_vice.c` |
...
| `card_passives` | `Drillago` | `src_custom/card_passives/drillago.c` |
| `card_passives` | `Thunder Nyan Nyan` | `src_custom/card_passives/thunder_nyan_nyan.c` |
...
| `battle_effects` | `Ghost Knight of Jackal` | `src_custom/battle_effects/ghost_knight_of_jackal.c` |
...
| `activated_effects` | `Elemental HERO Blazeman` | `src_custom/activated_effects/elemental_hero_blazeman.c` |
| `activated_effects` | `Elemental HERO Gaia` | `src_custom/activated_effects/elemental_hero_gaia.c` |
| `permanent_effects` | `Elemental HERO Flash` | `src_custom/permanent_effects/elemental_hero_flash.c` |
...
| `battle_effects` | `Elemental HERO Voltic` | `src_custom/battle_effects/elemental_hero_voltic.c` |
| `permanent_effects` | `Elemental HERO Absolute Zero` | `src_custom/permanent_effects/elemental_hero_absolute_zero.c` |
