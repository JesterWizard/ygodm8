...
WALK_OBJECT_X(14, 90)
DELAY(16)
MOVE_OBJECT(SPRITE_SETO, DIRECTION_RIGHT, 8, 0)
DELAY(16)
...
HIDE_PORTRAIT()
DELAY(16)
MOVE_OBJECT(SPRITE_MOKUBA, DIRECTION_RIGHT, 8, 0)
DELAY(16)
