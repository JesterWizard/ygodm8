...
DELAY(16)
MOVE_OBJECT(SPRITE_TRISTAN, DIRECTION_DOWN, 0, 0)
DELAY(16)
...
WALK_OBJECT_X(SPRITE_SERENITY, 76)
...
HIDE_PORTRAIT()
DELAY(43)
WALK_OBJECT_X(SPRITE_TRISTAN, 48)
WALK_OBJECT_X(14, 68)
DELAY(32)
TALK(PORTRAIT_SERENITY, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO,
...
REACTION(REACTION_SWEATDROP, SPRITE_TRISTAN | SPRITE_DUKE | OBJECT_14)
DELAY(16)
TALK(PORTRAIT_JOEY, EXPRESSION_JOEY_SWEATDROP, PORTRAIT_POSITION_AUTO,
...
WALK_OBJECT_X(SPRITE_TRISTAN, 144)
TALK(PORTRAIT_DUKE, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO,
    "Hey, wait! You can't ditch\n"
    "me!\n\n"
)
WALK_OBJECT_X(SPRITE_DUKE, 144)
MOVE_OBJECT(SPRITE_SERENITY, DIRECTION_RIGHT, 4, 1)
