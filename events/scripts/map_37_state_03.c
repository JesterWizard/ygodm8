...
EVENT_SCRIPT_REPLACEMENT(0x08ECD8A4, map_37_state_03_08ECD8A4, 0x08F04040, 0x08F04040)
  ...
  LANGUAGE_TEXT(3, "Qui c'\xe8 n'\xe8 un mucchio\ndi scimmie strane.\n\nSi trovano nella foresta\npluviale.\n\n")
  LANGUAGE_TEXT(4, "Hay un mont\xf3n de\nmonos extra\xf1os aqu\xed.\n\nEst\xe1n en la selva.\n\n")
  END_LANGUAGE_TEXT()
  FALLTHROUGH()
END_EVENT_SCRIPT()
...
EVENT_SCRIPT_REPLACEMENT(0x08ECD8B0, map_37_state_03_08ECD8B0, 0x08F04040, 0x08F04040)
  ...
  LANGUAGE_TEXT(3, "Oggigiorno le scimmie\nsanno pure duellare.\n\nSe hai tempo da perdere,\nvai nella foresta pluviale.\n\n")
  LANGUAGE_TEXT(4, "Los monos de hoy\nen d\xeda puedes hasta\n\nbatirse en duelo.\n\nSi tienes tiempo de\nsobra, ve a la selva.\n\n")
  END_LANGUAGE_TEXT()
  FALLTHROUGH()
END_EVENT_SCRIPT()
