...
EVENT_SCRIPT_REPLACEMENT(0x08E47860, map_02_state_06_08E47860, 0x08E47878, EVENT_NOP)
  ...
  DELAY(8)
  TALK(PORTRAIT_NEO_GHOUL, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO, "Wh-who are you?")
  TALK(PORTRAIT_NONE, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO,
      "I-I'm t-the Greendale Zom...",
      "Y-you bad guys don't deserve to know my name!"
  )
  TALK(PORTRAIT_NEO_GHOUL, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO, "Little twerp! I'll make you regret facing me!")
  HIDE_PORTRAIT()
  DELAY(8)
  WALK_OBJECT_Y(SPRITE_NEO_GHOUL, 40)
  SLIDE_OBJECT(SPRITE_GREENDALE_ZOMPIRE, 0, 12)
  PLAY_MUSIC(MUSIC_277)
  TALK(PORTRAIT_NEO_GHOUL, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO, "Graaaaaaaaah!")
  HIDE_PORTRAIT()
  DELAY(8)
  ...
  DELAY(8)
  TEXT("Th-there! Th-that serves you right!")
  TALK(PORTRAIT_NEO_GHOUL, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO,
      "...Come on, you didn't think that actually hurt me?",
      "Time to put this wannabe superhero to sleep!"
  )
  HIDE_PORTRAIT()
  DELAY(16)
  WALK_OBJECT_Y(SPRITE_NEO_GHOUL, 48)
  DELAY(16)
  TALK(PORTRAIT_NEO_GHOUL, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO, "Hand over your rare cards right now!")
  HIDE_PORTRAIT()
  DELAY(8)
  ...
  TEXT(
      ...
      "...No!",
      "A superhero never flies from danger!"
  )
  HIDE_PORTRAIT()
  DELAY(16)
  ...
  DELAY(32)
  TALK(PORTRAIT_NONE, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO, "I will not flee!")
  HIDE_PORTRAIT()
  DELAY(8)
  WALK_OBJECT_Y(SPRITE_LINT, 40)
  DELAY(8)
  TALK(PORTRAIT_NEO_GHOUL, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO,
      "You persistent pest! You're annoying me...",
      "I'll let someone else deal with this fool...",
      "I can't waste time playing with kids."
  )
  HIDE_PORTRAIT()
  DELAY(16)
  ...
  DELAY(16)
  TEXT(
      "I wasn't cool like the actual Zompire...",
...
EVENT_SCRIPT_REPLACEMENT(0x08E47878, map_02_state_06_08E47878, EVENT_NOP, EVENT_NOP)
  WALK_OBJECT_Y(0, 66)
...
EVENT_SCRIPT_REPLACEMENT(0x08E4786C, map_02_state_06_08E4786C, 0x08E47884, EVENT_NOP)
  WALK_OBJECT_Y(2, 24)
  TEXT("S-stop picking on the weak!")
  HIDE_PORTRAIT()
  DELAY(8)
...
EVENT_SCRIPT_REPLACEMENT(0x08E47884, map_02_state_06_08E47884, EVENT_NOP, EVENT_NOP)
  WALK_OBJECT_X(0, 8)
