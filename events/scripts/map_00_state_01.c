...
EVENT_SCRIPT_REPLACEMENT(0x08E349DC, map_00_state_01_08E349DC, 0x08F04040, 0x08F04040)
  ...
  LANGUAGE_TEXT(3, "Le carte divine servono per\nrinchiudere il Tenebroso.\n\nPrima bisogna ritrasformare\nla pietra in carte divine.\n\nPer farlo occorrono gli\nOggetti Millenari.\n\nIl primo Oggetto Millenario\nsi trova alla Mostra\n\nEgizia.\n\nPotete raggiungere la Mostra\ndalla stazione ferroviaria.\n\n")
  LANGUAGE_TEXT(4, "Se necesitan las cartas\nde los dioses para sellar\n\nal Ser Oscuro.\nPrimero, hay que\n\ncambiarlas a su estado\noriginal del p\xe9treo.\n\nPara hacerlo, se necesitan\nlos Objetos del Milenio.\n\nEl primer Objeto del\nMilenio est\xe1 en\n\nla Exposici\xf3n Egipcia.\n\nPod\xe9is llegar a ella desde\nla estaci\xf3n de tren.\n\n")
  END_LANGUAGE_TEXT()
  FALLTHROUGH()
END_EVENT_SCRIPT()
...
EVENT_SCRIPT_REPLACEMENT(0x08E349E8, map_00_state_01_08E349E8, 0x08F04040, 0x08F04040)
  ...
  LANGUAGE_TEXT(3, "Vi prego, raggiungete in\nfretta la Mostra Egizia.\n\nIl mondo cadr\xe0 presto\nnelle grinfie di\n\nReshef il Tenebroso.\n\n")
