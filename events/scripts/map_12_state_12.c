...
OBJECT_EFFECT(SPRITE_REBECCA, OBJECT_EFFECT_JUMPING)
DELAY(8)
...
HIDE_PORTRAIT()
DELAY(8)
MOVE_OBJECT(SPRITE_REBECCA, DIRECTION_RIGHT, 0, 0)
MOVE_OBJECT(SPRITE_TEDDY, DIRECTION_LEFT, 0, 0)
DELAY(8)
PORTRAIT(PORTRAIT_TEDDY, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO)
DELAY(96)
HIDE_PORTRAIT()
DELAY(8)
MOVE_OBJECT(SPRITE_REBECCA, DIRECTION_UP, 0, 0)
MOVE_OBJECT(SPRITE_TEDDY, DIRECTION_UP, 0, 0)
DELAY(16)
TALK(PORTRAIT_REBECCA, 5, PORTRAIT_POSITION_AUTO,
...
REACTION(REACTION_ANGRY, SPRITE_REBECCA)
DELAY(8)
TALK(PORTRAIT_REBECCA, 5, PORTRAIT_POSITION_AUTO,
...
DELAY(8)
PLAY_MUSIC(MUSIC_271)
REACTION(REACTION_EXCLAMATION_MARK, OBJECT_0 | SPRITE_REBECCA | OBJECT_13 | OBJECT_14)
DELAY(8)
MOVE_OBJECT(SPRITE_REBECCA, DIRECTION_DOWN, 0, 0)
MOVE_OBJECT(SPRITE_TEDDY, DIRECTION_DOWN, 0, 0)
DELAY(8)
WALK_OBJECT_X(13, 24)
WALK_OBJECT_Y(13, 48)
...
HIDE_PORTRAIT()
DELAY(16)
MOVE_OBJECT(SPRITE_REBECCA, DIRECTION_RIGHT, 2, 0)
DELAY(8)
PLAY_MUSIC(MUSIC_372)
SHOW_OBJECT(SPRITE_TEDDY, 128, 96, 0, 0, 0)
DELAY(8)
WALK_OBJECT_X(SPRITE_REBECCA, 40)
WALK_OBJECT_Y(SPRITE_REBECCA, 40)
MOVE_OBJECT(SPRITE_REBECCA, DIRECTION_RIGHT, 0, 0)
DELAY(8)
PLAY_MUSIC(MUSIC_372)
SHOW_OBJECT(SPRITE_TEDDY, 48, 40, 0, 0, 0)
MOVE_OBJECT(SPRITE_REBECCA, DIRECTION_DOWN, 0, 0)
DELAY(8)
...
MOVE_OBJECT(SPRITE_SETO, DIRECTION_LEFT, 16, 0)
TALK(PORTRAIT_MOKUBA, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO,
...
HIDE_PORTRAIT()
DELAY(16)
WALK_OBJECT_X(SPRITE_MOKUBA, 0)
MOVE_OBJECT(SPRITE_MOKUBA, DIRECTION_LEFT, 16, 0)
PLAY_MUSIC(MUSIC_275)
REACTION(REACTION_ANGRY, OBJECT_14)
DELAY(16)
PLAY_MUSIC(MUSIC_272)
REACTION(REACTION_ELLIPSIS, SPRITE_REBECCA)
DELAY(16)
MOVE_OBJECT(13, DIRECTION_RIGHT, 0, 0)
DELAY(16)
TALK(PORTRAIT_YUGI, EXPRESSION_NEUTRAL, PORTRAIT_POSITION_AUTO,
...
MOVE_OBJECT(14, DIRECTION_RIGHT, 0, 0)
DELAY(64)
MOVE_OBJECT(SPRITE_REBECCA, DIRECTION_LEFT, 0, 0)
MOVE_OBJECT(SPRITE_TEDDY, DIRECTION_LEFT, 0, 0)
DELAY(16)
TALK(PORTRAIT_REBECCA, 5, PORTRAIT_POSITION_AUTO,
    "I don't care...\n\n"
...
SHOW_OBJECT(SPRITE_TEDDY, 128, 96, 0, 0, 0)
DELAY(8)
WALK_OBJECT_X(SPRITE_REBECCA, 0)
MOVE_OBJECT(SPRITE_REBECCA, DIRECTION_LEFT, 16, 0)
DELAY(16)
