...
SHOW_OBJECT(SPRITE_VIDEO_CARD, 44, 36, 0, 0, 0)
DELAY(16)
PLAY_MUSIC(MUSIC_272)
REACTION(REACTION_ELLIPSIS, SPRITE_NEO_GHOUL)
DELAY(16)
...
DELAY(8)
PLAY_MUSIC(MUSIC_285)
SHOW_OBJECT(SPRITE_VIDEO_CARD, 44, 96, 0, 0, 0)
DELAY(8)
TEXT
(
...
HIDE_PORTRAIT()
DELAY(32)
MOVE_OBJECT(SPRITE_ETSUKO, DIRECTION_DOWN, 0, 0)
DELAY(32)
...
HIDE_PORTRAIT()
DELAY(16)
MOVE_OBJECT(SPRITE_TAKESHI, DIRECTION_DOWN, 0, 0)
DELAY(16)
TEXT
(
...
HIDE_PORTRAIT()
DELAY(16)
WALK_OBJECT_X(SPRITE_NEO_GHOUL, 14)
WALK_OBJECT_Y(SPRITE_NEO_GHOUL, 42)
WALK_OBJECT_X(SPRITE_NEO_GHOUL, 0)
SHOW_OBJECT(SPRITE_NEO_GHOUL, 128, 96, 0, 0, 0)
MOVE_OBJECT(SPRITE_TAKESHI, DIRECTION_LEFT, 0, 0)
HIDE_PORTRAIT()
FADE_MUSIC(2)
DELAY(32)
TEXT
...
REACTION(REACTION_LOVE_HEART, SPRITE_ETSUKO)
DELAY(16)
TEXT
(
    "Like, thank you.\n"
