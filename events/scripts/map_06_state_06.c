...
DELAY(8)
WALK_OBJECT_X(SPRITE_NEO_GHOUL, 52)
DELAY(8)
...
WALK_OBJECT_X(SPRITE_DUKE, 52)
WALK_OBJECT_X(SPRITE_NEO_GHOUL, 64)
MOVE_OBJECT(SPRITE_NEO_GHOUL, DIRECTION_LEFT, 0, 0)
WALK_OBJECT_Y(SPRITE_TRISTAN, 44)
WALK_OBJECT_X(SPRITE_TRISTAN, 56)
WALK_OBJECT_Y(SPRITE_DUKE, 52)
WALK_OBJECT_X(SPRITE_DUKE, 56)
DELAY(16)
...
HIDE_PORTRAIT()
DELAY(16)
WALK_OBJECT_X(SPRITE_NEO_GHOUL, 144)
...
TALK(PORTRAIT_TRISTAN, EXPRESSION_TRISTAN_TEETH_GRITTED, PORTRAIT_RIGHT,
    "Devlin, you...\n\n"
)
HIDE_PORTRAIT()
DELAY(8)
...
DELAY(8)
PLAY_MUSIC(MUSIC_271)
REACTION(REACTION_EXCLAMATION_MARK, SPRITE_TRISTAN | SPRITE_DUKE)
DELAY(16)
WALK_OBJECT_X(0, 72)
WALK_OBJECT_Y(13, 42)
WALK_OBJECT_X(13, 82)
