...
SET_OBJECT_POSITION(SPRITE_PLAYER, 70, 62, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(SPRITE_YUGI, 50, 96, 0, DIRECTION_DOWN)
SET_OBJECT_POSITION(SPRITE_JOEY, 80, 62, 0, DIRECTION_LEFT)
FADE_IN(4)
...
// TALK(PORTRAIT_ATEM, EXPRESSION_NEUTRAL, PORTRAIT_LEFT, "Now I play Monster Reborn!\n\n")
// HIDE_CG(2)
...
REACTION(REACTION_SWEATDROP, SPRITE_PLAYER)
DELAY(16)
TALK(PORTRAIT_JOEY, EXPRESSION_NEUTRAL, PORTRAIT_LEFT,
    "Hey,\n"
...
REACTION(REACTION_EXCLAMATION_MARK, SPRITE_PLAYER)
DELAY(8)
MOVE_OBJECT(SPRITE_PLAYER, DIRECTION_LEFT, 0, 0)
DELAY(16)
...
REACTION(REACTION_QUESTION_MARK, SPRITE_PLAYER)
DELAY(16)
