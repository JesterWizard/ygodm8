...
SET_OBJECT_POSITION(0, 4, 60, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(13, 0, 54, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(14, 0, 66, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(1, 88, 60, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(2, 96, 32, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(3, 38, 60, 0, DIRECTION_LEFT)
SET_OBJECT_POSITION(4, 26, 14, 0, DIRECTION_RIGHT)
FADE_IN(4)
