...
LOAD_SPRITE(SLOT_PLAYER, SPRITE_PLAYER)
...
SET_OBJECT_POSITION(SPRITE_PLAYER, 4, 60, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(SPRITE_YUGI, 0, 66, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(SPRITE_JOEY, 0, 54, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(SPRITE_RED_HAT, 88, 60, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(SPRITE_STYLISH_HAIR, 96, 32, 0, DIRECTION_RIGHT)
SET_OBJECT_POSITION(SPRITE_TEA, 38, 60, 0, DIRECTION_LEFT)
SET_OBJECT_POSITION(SPRITE_ISHIZU, 26, 14, 0, DIRECTION_RIGHT)
FADE_IN(4)
PLAY_MUSIC(MUSIC_CLOCK_TOWER_SQUARE)
WALK_OBJECT_X(SPRITE_PLAYER, 24)
WALK_OBJECT_X(SPRITE_JOEY, 28)
WALK_OBJECT_X(SPRITE_YUGI, 28)
...
HIDE_PORTRAIT()
DELAY(64)
WALK_OBJECT_X(SPRITE_ISHIZU, 40)
...
REACTION(REACTION_EXCLAMATION_MARK, SPRITE_PLAYER | SPRITE_TEA | SPRITE_YUGI | SPRITE_JOEY)
DELAY(8)
MOVE_OBJECT(SPRITE_PLAYER, DIRECTION_UP, 0, 0)
...
REACTION(REACTION_QUESTION_MARK, SPRITE_PLAYER | SPRITE_TEA | SPRITE_YUGI | SPRITE_JOEY)
DELAY(16)
TALK(PORTRAIT_ISHIZU, EXPRESSION_NEUTRAL, PORTRAIT_RIGHT,
...
HIDE_PORTRAIT()
DELAY(32)
WALK_OBJECT_X(SPRITE_ISHIZU, 24)
DELAY(32)
TALK(PORTRAIT_ISHIZU, EXPRESSION_NEUTRAL, PORTRAIT_RIGHT,
...
HIDE_PORTRAIT()
DELAY(32)
MOVE_OBJECT(SPRITE_ISHIZU, DIRECTION_DOWN, 4, 0)
DELAY(16)
TALK(PORTRAIT_ISHIZU, EXPRESSION_NEUTRAL, PORTRAIT_RIGHT,
    "Please, my powerful\n"
    "duelists...\n\n"
...
MOVE_OBJECT(SPRITE_PLAYER, DIRECTION_DOWN, 0, 0)
...
HIDE_PORTRAIT()
DELAY(32)
WALK_OBJECT_X(SPRITE_ISHIZU, 16)
DELAY(32)
MOVE_OBJECT(SPRITE_ISHIZU, DIRECTION_DOWN, 0, 0)
DELAY(32)
TALK(PORTRAIT_ISHIZU, EXPRESSION_NEUTRAL, PORTRAIT_RIGHT,
...
FADE_MUSIC(4)
MOVE_OBJECT(SPRITE_ISHIZU, DIRECTION_LEFT, 32, 0)
PLAY_MUSIC(MUSIC_CLOCK_TOWER_SQUARE)
